# Names of physical constants from Wikidata.
# The terms are choosen from the results of the following Wikidata query:
...
PHYSICAL_CONSTANTS = sorted(PHYSICAL_CONSTANTS, key=lambda x: len(x), reverse=True)

PHYSICAL_CONSTANTS_LOWERED = [c.lower() for c in PHYSICAL_CONSTANTS]
